...
class MapScreenState extends State<MapScreen> {
 ...
 Future<String?> _uploadScreenshotToFirebase() async {
    if (_screenshotFile != null) {
      Reference firebaseStorageRef = FirebaseStorage.instance.ref().child('screenshots/${_screenshotFile!.path}');
      UploadTask uploadTask = firebaseStorageRef.putFile(_screenshotFile!);
    ...
    return Scaffold(
      ...
      body: (loading)
          ...
          : SafeArea(
              child: Stack(
                children: [
                  // FloatingActionButton(onPressed: _takeAndSaveScreenshot, child: const Icon(Icons.save)),
                  Screenshot(
    ...
    return SpeedDial(
      ...
      children: [
        ...
        SpeedDialChild(
          ...
          String? downloadUrl = await _uploadScreenshotToFirebase();
          if (downloadUrl != null) {
